"""
Based on Qt loader from IPython
"""
...
def has_binding(api):
    ...
    try:
        ...
        if find_module("QtGui") or find_module("QtSvg") or find_module("QtCore"):
            return True
...
def import_pyqt4(version=2):
    ...
    return QtCore, QtGui, QtSvg, QtNetwork, api
...
def import_pyqt5():
    ...
    from PyQt5 import QtCore, QtSvg, QtWidgets, QtGui, QtNetwork
    ...
    api = QT_API_PYQT5
    return QtCore, QtGuiCompat, QtSvg, QtNetwork, api
...
def import_pyside():
    ...
    """
    from PySide import QtGui, QtCore, QtSvg, QtNetwork
    return QtCore, QtGui, QtSvg, QtNetwork, QT_API_PYSIDE
